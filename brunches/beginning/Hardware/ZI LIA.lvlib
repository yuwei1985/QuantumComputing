...
<Library LVVersion="16008000">
	...
	<Item Name="LIA_DAQ_Main(trigger).vi" Type="VI" URL="../LIA_DAQ_Main(trigger).vi"/>
	<Item Name="LIA_DAQ_Read.vi" Type="VI" URL="../LIA_DAQ_Read.vi"/>
	<Item Name="LIA_DAQ_SetModuleParameters.vi" Type="VI" URL="../LIA_DAQ_SetModuleParameters.vi"/>
	<Item Name="LIA_Initialization.vi" Type="VI" URL="../LIA_Initialization.vi"/>
</Library>
